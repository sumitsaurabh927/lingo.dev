...
<p align="center">
  <a href="https://lingo.dev/compiler">מהדר Lingo.dev</a> •
  <a href="https://lingo.dev/cli">ממשק שורת פקודה Lingo.dev</a> •
  <a href="https://lingo.dev/ci">Lingo.dev CI/CD</a> •
  <a href="https://lingo.dev/sdk">ערכת פיתוח Lingo.dev</a>
</p>
...
**מהדר Lingo.dev** הוא מידלוור קומפילציה חינמי וקוד פתוח, המתוכנן להפוך כל אפליקציית React לרב-לשונית בזמן הבנייה מבלי לדרוש שינויים ברכיבי React הקיימים.
...
| כלי                 | תקציר                                                                     | תיעוד                                   |
| ------------------- | ------------------------------------------------------------------------- | --------------------------------------- |
| **מהדר**            | לוקליזציה של React בזמן בנייה                                             | [/compiler](https://lingo.dev/compiler) |
| **ממשק שורת פקודה** | פקודה אחת ללוקליזציה של אפליקציות ווב ומובייל, JSON, YAML, markdown, ועוד | [/cli](https://lingo.dev/cli)           |
| **CI/CD**           | קומיט אוטומטי של תרגומים בכל דחיפה + יצירת בקשות משיכה במידת הצורך        | [/ci](https://lingo.dev/ci)             |
| **ערכת פיתוח**      | תרגום בזמן אמת לתוכן שנוצר על ידי משתמשים                                 | [/sdk](https://lingo.dev/sdk)           |

להלן סקירה מהירה של כל אחד 👇

---

### ⚡️ ממשק שורת פקודה Lingo.dev
