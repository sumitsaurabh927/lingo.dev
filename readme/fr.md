> [!Note] > **Présentation : Lingo.dev Compiler** - Rendez n'importe quelle application React multilingue au moment de la compilation sans modifier vos composants. [Lire la documentation](https://lingo.dev/compiler).
