> [!Note] > **Presentamos: Lingo.dev Compiler** - Haz que cualquier aplicación React sea multilingüe durante la compilación sin cambiar tus componentes. [Lee la documentación](https://lingo.dev/compiler).
